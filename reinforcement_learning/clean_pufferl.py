...
def evaluate(data):
    ...
    data.agent_step += agent_steps_collected
    ...
    data.agent_SPS = int(agent_steps_collected / eval_profiler.elapsed)
    ...
    perf.eval_sps = int(agent_steps_collected / eval_profiler.elapsed)
