...
class CleanPuffeRL:
    ...
    def __post_init__(self, *args, **kwargs):
        ...
        self.scheduler = CosineAnnealingWarmRestarts(self.optimizer, int(self.total_updates / 100), 2)
    ...
    def train(
        ...
        for epoch in range(update_epochs):
            ...
            for mb in range(num_minibatches):
                ...
                loss.backward()
                self.optimizer.step()
                if anneal_lr: self.scheduler.step(self.update)
