...
class StatPostprocessor(pufferlib.emulation.Postprocessor):
    ...
    def _reset_episode_stats(self):
        self._alive_agents = set(self.teams[self.team_id])
    ...
    def rewards(self, team_rewards, team_dones, team_infos, step):
        # Provide unique event count in the Postprocessor
        if self._alive_agents:
        ...
        for agent_id in team_dones:
            if team_dones[agent_id] is True:
                ...
                self._alive_agents.remove(agent_id)
    ...
    def infos(self, team_reward, env_done, team_done, team_infos, step):
        ...
        if env_done:
            ...
            team_infos["stats"]["achieved/team_time_alive"] = self._time_alive
            team_infos["stats"]["achieved/unique_events"] = self._curr_unique_count
            ...
            team_result.total_score = self._curr_unique_count
